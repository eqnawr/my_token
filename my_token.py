...
# A smart contract maintains and enforces changes to “current state”.
...
# A smart contract MUST have one exported method to be valid.
# Methods without an export decorator can only be called internally by your smart contract.
@export
# This is our transfer method definition (which we are exporting).
